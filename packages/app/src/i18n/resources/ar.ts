...
export const ar: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      searchBack: "البحث في الرجوع",
      searchForward: "البحث في التقدم",
      ...
      historyCount: "{{count}} متاح",
      setDefaultSearchSettings: "تعيين إعدادات البحث الافتراضية",
      showAll: "إظهار كل {{count}} {{group}}",
    },
  },
  composer: {
    placeholders: {
