...
export const ptBR: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      searchBack: "Buscar voltar",
      searchForward: "Buscar avançar",
      ...
      historyCount: "{{count}} disponíveis",
      setDefaultSearchSettings: "Definir busca padrão",
  ...
  agentStream: {
    ...
    find: {
      ...
      searchThinking: "Buscar no raciocínio",
