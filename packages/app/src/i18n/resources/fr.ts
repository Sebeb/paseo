...
export const fr: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      searchBack: "Rechercher en arrière",
      searchForward: "Rechercher en avant",
      ...
      setDefaultSearchSettings: "Définir la recherche par défaut",
      showAll: "Afficher les {{count}} {{group}}",
    },
  },
  composer: {
    placeholders: {
