...
export const es: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      searchBack: "Buscar atrás",
      searchForward: "Buscar adelante",
      ...
      historyCount: "{{count}} disponibles",
      setDefaultSearchSettings: "Establecer búsqueda predeterminada",
      showAll: "Mostrar todos {{count}} {{group}}",
    },
  },
  composer: {
    placeholders: {
  ...
  agentStream: {
    ...
    find: {
      ...
      searchThinking: "Buscar en pensamiento",
      matchCount: "{{current}} de {{total}}",
      scanning: "Buscando {{current}}/{{total}}",
    },
    thinking: {
      label: "Pensamiento",
  ...
  workspace: {
    ...
    tabs: {
      ...
      toasts: {
        ...
        markReadFailed: "Failed to mark chat as read",
        markUnreadFailed: "Failed to mark chat as unread",
        ...
        failedToDuplicateChat: "No se pudo duplicar el chat",
      },
      confirmations: {
        close: "Cerca",
        cancel: "Cancelar",
  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        findInThread: "Buscar en el chat",
