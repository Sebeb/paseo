...
export const ru: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      forward: "Вперед",
      window: "Окно",
      currentWorkspace: "Текущая область",
      currentProject: "Текущий проект",
      allProjects: "Все проекты",
      historyCount: "Доступно: {{count}}",
      setDefaultSearchSettings: "Задать поиск по умолчанию",
      showAll: "Показать все {{count}} {{group}}",
    },
  },
  composer: {
    placeholders: {
