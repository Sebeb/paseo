...
export const ja: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      historyCount: "{{count}}件利用可能",
      setDefaultSearchSettings: "既定の検索設定にする",
      showAll: "{{count}}件の{{group}}をすべて表示",
    },
  },
  composer: {
    placeholders: {
  ...
  agentStream: {
    ...
    find: {
      ...
      previous: "前の一致",
      next: "次の一致",
      searchThinking: "思考を検索",
      matchCount: "{{current}} / {{total}}",
      scanning: "{{current}}/{{total}} を検索中",
    },
    thinking: {
      label: "思考",
